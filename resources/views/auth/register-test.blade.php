  ...
  <div class="container" style="margin-top: 56px;">
    <div class="row">
      <div class="col-md-12 card">
        <div class="col-md-6 offset-md-3 register-section">
          <div class="card">
            ...
            <div class="card-body collapse in">
              <div class="card-block">
                <form class="form" id="register_user_form" method="POST" action="{{ url('payment-beta') }}">
                  {{ csrf_field() }}
                  <div class="form-body">
                    ...
                    <button type="submit" class="btn btn-primary register-user"> <i class="fa fa-check-square-o"></i> Register </button>
